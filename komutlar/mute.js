...
aliases:"sustur",
code:`
$sendDM[$mentioned[1];$customEmoji[unmute] **$serverName** sunucusunda mute süren bitmiştir. Tekrardan kanallara yazabilirsin.]
$onlyIf[$getUserVar[mute;$mentioned[1]]!=no;]
$channelSendMessage[$channelID;$customEmoji[unmute] <@$mentioned[1]>, Mute süren bitti. Tekrardan kanallara yazabilirsin.]
...
$sendDM[$mentioned[1];$customEmoji[mute] **$serverName** sunucusunda "$replaceText[$noMentionMessage;$noMentionMessage[1];;-1] " sebebinden mutelendin.]
$channelSendMessage[$channelID;{author:Üye mutelendi!:$userAvatar[$mentioned[1]]}{description:$customEmoji[mute] <@$mentioned[1]> adlı üye **$noMentionMessage[1]** boyunca "$replaceText[$noMentionMessage;$noMentionMessage[1];;-1] " sebebinden susturuldu}{color:BLACK}{thumbnail:$userAvatar[$mentioned[1]]}]
