module.exports = {
  ...
  aliases:"hapis",
  code:`
$sendDM[$mentioned[1];$customEmoji[jail] **$serverName** sunucusunda "$noMentionMessage[1]" sebebinden jaile atıldın.]
$channelSendMessage[$channelID;{author:Üye jaile atıldı!:$userAvatar[$mentioned[1]]}{description:$customEmoji[jail] <@$mentioned[1]> adlı üye "$noMentionMessage" sebebinden jaile atıldı}{color:BLACK}{thumbnail:$userAvatar[$mentioned[1]]}]
